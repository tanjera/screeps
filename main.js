...
module.exports.loop = function () {
    ...
    */     
    ...
    // siteMining.run (rmColony, rmHarvest, popBurrower, popCarrier, popMiner, popMultirole, popReserver, popExtractor)
    ...
    siteColony.run('W18S43', 1, 1, 0, 0,       // W16S43 colony #1
    ...
    siteColony.run('W16S43', 2, 1, 0, 0);      // W16S43 colony #2
    ...
    siteMining.run('W19S42', 'W18S42', 1, 3, 0, 1, 1, 0);    // W18S42 mining operation (from Colony #3, W19S42)
    
    siteMining.run('W15S41', 'W15S42', 1, 3, 0, 1, 1, 0);    // W15S42 mining operation (from Colony #4, W15S41)
    siteMining.run('W15S41', 'W16S41', 1, 2, 0, 1, 1, 0);    // W16S41 mining operation (from Colony #4, W15S41)
