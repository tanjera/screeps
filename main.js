...
*/     
    ...
    // siteColony.run(spawn, rmColony, popWorker, popSoldier)
    // siteMining.run(spawn, rmDeliver, rmHarvest, popBurrower, popCarrier, popMiner)

    siteColony.run(Game.spawns.Spawn1, 'W18S43', 8, 1);     // W16S43 colony #1
    ...
    siteColony.run(Game.spawns.Spawn2, 'W16S43', 6, 1);     // W16S43 colony #2
