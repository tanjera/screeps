...
module.exports.loop = function () {
    ...
    */     
    ...
    siteColony.run('W15S41', 1.0, 5, 1, 2, 0,       // W15S41 colony #4
            [{id: '57abd1d35c977d2d5fec0d0f', role: 'send'},            
             {id: '57abe33f4a8b4b5a2f1a2b85', role: 'receive'}]);

    siteMining.run('W18S43', 'W18S43', 0.8, 1, 2, 0, 0, 0, 0);    // W18S43 colony #1 mining
    ...
    siteMining.run('W18S43', 'W19S43', 0.8, 1, 2, 0, 1, 1, 0);    // W19S43 mining operation (from Colony #1, W18S43)
    siteMining.run('W18S43', 'W17S42', 0.8, 1, 2, 0, 1, 1, 0);    // W17S42 mining operation (from Colony #1, W18S43)
    
    siteMining.run('W16S43', 'W16S42', 1.0, 1, 4, 0, 1, 1, 0);    // W16S42 mining operation (from Colony #2, W16S43)
    siteMining.run('W16S43', 'W14S43', 0.8, 1, 2, 0, 1, 1, 0);    // W14S43 mining operation (from Colony #2, W16S43)
    siteMining.run('W16S43', 'W15S43', 0.8, 1, 2, 0, 1, 1, 0);    // W15S43 mining operation (from Colony #2, W16S43)
