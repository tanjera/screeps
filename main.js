...
*/     
    ...
    siteMining.run(Game.spawns.Spawn1, 'W18S43', 'W18S43', 1, 3, 0);    // W18S43 colony #1 mining
    siteMining.run(Game.spawns.Spawn2, 'W16S43', 'W16S43', 1, 2, 0);    // W16S43 colony #2 mining
    siteColony.run(Game.spawns.Spawn1, 'W18S43', 1, 4, 1);     // W16S43 colony #1
    siteColony.run(Game.spawns.Spawn2, 'W16S43', 1, 4, 1);     // W16S43 colony #2

    /* All other mining operations */
    siteMining.run(Game.spawns.Spawn1, 'W18S43', 'W17S43', 1, 3, 0);    // W17S43 mining operation (from Colony #1, W18S43)
    siteMining.run(Game.spawns.Spawn1, 'W18S43', 'W19S43', 1, 2, 0);    // W19S43 mining operation (from Colony #1, W18S43)
    
    siteMining.run(Game.spawns.Spawn2, 'W16S43', 'W16S42', 1, 3, 0);    // W16S42 mining operation (from Colony #2, W16S43)
    siteMining.run(Game.spawns.Spawn2, 'W16S43', 'W17S42', 1, 3, 0);    // W17S42 mining operation (from Colony #2, W16S43)
