...
module.exports.loop = function () {
    ...
    /* TO DO:
          ...
          implement spawning from multiple spawns in one room
                make function utilColony.spawn(room)
    */     
    ...
    siteColony.run('W18S43', 0, 3, 0);     // W16S43 colony #1
    siteColony.run('W16S43', 1, 1, 0);     // W16S43 colony #2
    ...
    //siteMining.run('W16S43', 'W17S42', 1, 2, 0, 0, 0);    // W17S42 mining operation (from Colony #2, W16S43)
