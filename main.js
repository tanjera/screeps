...
module.exports.loop = function () {
    ...
    */     
    ...
    // utilHive.requestSpawn (rmName, rmDistance, lvlPriority, tgtLevel, cBody, cName, cArgs)
    ...
    siteColony.run('W18S43', 6, 1, 1, 1, 0,       // W16S43 colony #1
    ...
    siteColony.run('W19S42', 6, 4, 1, 1, 0,       // W19S42 colony #2
            [{id: '57a23067cf975f59293d8a28', role: 'send'},
             {id: '57a23201113c59e97f7e364e', role: 'receive'},
             {id: '57a6a9d62d673fac4f21a62a', role: 'receive'}]);    
    siteColony.run('W15S41', 4, 2, 1, 2, 0,       // W15S41 colony #3
            [{id: '57abd1d35c977d2d5fec0d0f', role: 'send'},            
             {id: '57abe33f4a8b4b5a2f1a2b85', role: 'receive'},
             {id: '57af99d528986c413c0a8f4c', role: 'receive'}]);
    siteColony.run('W15S43', 6, 5, 1, 1, 0);      // W15S43 colony #4

    siteMining.run('W18S43', 'W18S43', 6, 1, 2, 0, 0, 0, 0);    // W18S43 colony #1 mining
    siteMining.run('W19S42', 'W19S42', 6, 1, 2, 0, 0, 0, 0);    // W19S42 colony #2 mining
    siteMining.run('W15S41', 'W15S41', 5, 1, 2, 0, 0, 0, 0);    // W15S41 colony #3 mining
    siteMining.run('W15S43', 'W15S43', 4, 1, 1, 0, 0, 0, 0);    // W15S43 colony #2 mining
    
    /* All other mining operations */
    siteMining.run('W18S43', 'W17S43', 6, 1, 3, 0, 1, 1, 0);    // W17S43 mining operation (from Colony #1, W18S43)
    ...
    siteMining.run('W19S42', 'W18S42', 6, 1, 3, 0, 1, 1, 0);    // W18S42 mining operation (from Colony #2, W19S42)
    
    siteMining.run('W15S41', 'W15S42', 4, 1, 2, 0, 1, 1, 0);    // W15S42 mining operation (from Colony #3, W15S41)
    siteMining.run('W15S41', 'W14S42', 5, 1, 2, 0, 1, 1, 0);    // W15S42 mining operation (from Colony #3, W15S41)
    siteMining.run('W15S41', 'W16S41', 4, 1, 2, 0, 1, 1, 0);    // W16S41 mining operation (from Colony #3, W15S41)
    
    siteMining.run('W15S43', 'W16S43', 6, 1, 2, 0, 1, 1, 0);    // W14S43 mining operation (from Colony #4, W15S43)
    siteMining.run('W15S43', 'W14S43', 6, 1, 2, 0, 1, 1, 0);    // W15S43 mining operation (from Colony #4, W15S43)
    siteMining.run('W15S43', 'W16S42', 5, 1, 2, 0, 1, 1, 0);    // W16S42 mining operation (from Colony #4, W15S43)
    
    /* Reserve rooms for Atavus in W15S35 quad */
    siteReserve.run('W15S41', 'W15S39', 6, 1);
    siteReserve.run('W15S41', 'W13S39', 6, 1,
