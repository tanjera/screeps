...
var RolesMining = {
    ...
    Mine: function(creep, rmDeliver, rmHarvest) {
        switch (creep.memory.state) {
            ...
            case 'get_energy':
                ...
                RolesMining.Mine_GetEnergy(creep, rmDeliver, rmHarvest);
            break;
            ...
            case 'deliver':
                ...
                RolesMining.Mine_Deliver(creep, rmDeliver, rmHarvest);
            break;
        }
    },


    Mine_GetEnergy: function(creep, rmDeliver, rmHarvest) {
    ...
    Mine_Deliver: function(creep, rmDeliver, rmHarvest) {
        var _ticksReusePath = 10;
