...
module.exports = {
	...
	Run: function(rmColony, rmHarvest, listSpawnRooms, hasKeepers, listPopulation, listRoute) {
		...
		if (Hive.isPulse_Spawn()) {
			...
			this.runPopulation(rmColony, rmHarvest, listSpawnRooms, hasKeepers, listPopulation);
	...
	runPopulation: function(rmColony, rmHarvest, listSpawnRooms, hasKeepers, listPopulation) {		
