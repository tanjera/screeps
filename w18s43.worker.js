var w18s43Worker = {
    ...
    run: function(creep) {
        ...
        if (creep.memory.state == 'working' && creep.carry[RESOURCE_ENERGY] == 0 && creep.memory.role != 'w18s43defender') {
	    ...
	    // Upgrader
	    else if (creep.memory.state == 'working' && creep.memory.role == 'w18s43upgrader') {
	    ...
	    // Repairer
	    else if (creep.memory.state == 'working' && creep.memory.role == 'w18s43repairer') {
	    ...
	    // Defender
	    else if (creep.memory.state == 'working' && creep.memory.role == 'w18s43defender') {
	    // Have energy? ... is there something to attack??
	    ...
	    // Builder
	    else if (creep.memory.state == 'working' && creep.memory.role == 'w18s43builder') {
